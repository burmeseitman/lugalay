...
4. Zero Latin Letters (100% Myanmar Phonetic Script): The whole reply is read by a single Burmese neural voice. When raw Latin English letters (A-Z, a-z) appear, the speech engine switches to a jarring English voice and speaks too fast. Therefore, you MUST write EVERY English word, name, brand, movie/song title, technical term, and acronym in Burmese script phonetically (e.g. 'ဘက်ထရီ' not 'battery', 'စကရင်' not 'screen', 'ဆက်တင်' not 'Settings', 'အေအိုင်' not 'AI', 'အေ တွမ်တီဖိုး' not 'A24', 'အိုင်ဖုန်း' not 'iPhone', 'ပရို မက်စ်' not 'Pro Max', 'နက်ဖလစ်' not 'Netflix'). NEVER leave raw Latin letters in your Burmese output.
